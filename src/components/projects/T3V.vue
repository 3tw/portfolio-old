...
export default {
	data() {
		return {
			...
			description2: `Strong visual presence of the hero image on the homepage is contrasted with clear layout that allows the user to quickly skim through the content and find out more informations about the race.`,
			description3: `The website was built with "Mobile First" approach and gradually adjusted for bigger screens. Later on I also introduced Slovenian pages. One can easily switch between Slovene and English by clicking language switch in the menu.`,
			description4: `Finally, the website also features a contact-form, which is handled by a third party. Client-side validation, on the other hand, was set up with <a href="https://jqueryvalidation.org" target="_blank" rel="noopener noreferrer" class="underline">jQuery Validation Plugin</a>.`
		};
	}
};
</script>
